//LOGIN PAGE
import{CREATEACCOUNTMODULE, DELETEDACCOUNTMODULE,FORGOTPASSWORDMODULE,ICONMODULE,LOGINMODULE,POSTDEVICEMODULE}from "../Modules/Module.js";import{HOMEPAGE}from "./HomePage/HomePage.js";
...
const CREATEACCOUNTPAGE=()=>{
    ...
    CLICKED('.forestgreen',()=>{
        ...
        CREATEACCOUNTMODULE('.forestgreen','.UserName','.UserEmail','.UserPassword','.UserDate','.Userlocation','.UserTel',LOGINAPI,'Email',(user)=>{
            console.log(user)
        })
    })
